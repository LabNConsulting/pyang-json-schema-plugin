...
def produce_list(stmt):
    ...
    logging.debug("XXX parent %s %s", stmt.parent.keyword, stmt.parent.arg)
    ...
    if hasattr(stmt, 'i_children'):
        for child in stmt.i_children:
            if child.keyword in producers:
                ...
                #     # result[arg]["items"]["properties"][child.arg] = producers[child.keyword](child)
...
def produce_leaf_list(stmt):
    ...
    if types.is_base_type(type_id) and type_id in _other_type_trans_tbl:
        type_str = produce_type(type_stmt)
